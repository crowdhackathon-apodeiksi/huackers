...
if ( ! function_exists('myocr'))
{
  ...
  $applicationId = 'camelotapp';
  // Password should be sent to your e-mail after application was created
  $password = 'VYhQylT2HOTwhW+ZFfERpr1e';
  $fileName = 'myfile.jpg';

  // Get path to file that we are going to recognize
  $local_directory=dirname(__FILE__).'/../../abby/images';
  ...
  $url = 'http://cloud.ocrsdk.com/processImage?language=greek&exportFormat=txt';
