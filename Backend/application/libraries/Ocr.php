...
class Ocr {
  ...
  //protected $applicationId = 'Camelot_gre';
  protected $applicationId = 'camelotapp';
  // Password should be sent to your e-mail after application was created
  //protected $password = '5dodN8nXj7oee0HJa0cZbjXK ';
  protected $password = 'VYhQylT2HOTwhW+ZFfERpr1e';
  protected $fileName = 'myfile.jpg';

  // Get path to file that we are going to recognize
  protected $local_directory = '../images/';
  protected $filePath = "../../abby/images/myfile.jpg";
